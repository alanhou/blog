...
description:
  ...
  zh: "本文证明在大世界情境下通用智能体无法做到全能，标准最坏情况保证毫无意义。它提出结构性认证——一种基于过渡局部的框架，对智能体内部世界模型在特定组合目标上的每项误差给出界限。"
date: 2026-06-24
tags: ["arxiv", "ai", "cs.ai"]
image: "/arxiv-visuals/arxiv-world-models-in-pieces-structural-certification.png"
---
:::en
