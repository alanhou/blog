...
2. The tutorial demonstrates using the **Web Browser component** from the Palette (Tools `> W`eb Browser) to load reference video
...
2. 教程演示使用调色板中的**Web Browser组件**（Tools `> W`eb Browser）加载参考视频
