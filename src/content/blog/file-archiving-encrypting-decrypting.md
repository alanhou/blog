...
seriesOrder: 6
title:
  en: "Chapter 6: File Archiving, Encrypting, and Decrypting"
  zh: "第6章 文件存档、加密和解密"
description:
  en: "Create and extract TAR and ZIP archives, and learn file encryption and decryption techniques in Python."
  zh: "研究文件存档、创建存档以及TAR和ZIP包的创建，学习使用应用解压缩.tar和.zip文件。"
date: 2019-02-17
tags: ["python", "archiving", "encryption", "tar", "zip"]
