...
seriesOrder: 1
title:
  en: "Chapter 1: Quick Start Using the Developer Mode"
  zh: "第1章 使用开发者模式快速入门 Odoo 12"
description:
  en: "Get started with Odoo 12 using developer mode to create a to-do app, understand the framework structure, and learn basic customization."
  zh: "通过开发者模式快速入门Odoo 12，创建任务清单应用，了解框架结构并学习基本自定义操作。"
date: 2018-12-30
tags: ["odoo", "developer-mode", "quick-start", "customization"]
