...
seriesOrder: 1
title:
  en: "Chapter 1: Python Scripting Overview"
  zh: "第1章 Python脚本概述"
description:
  en: "Introduction to Python scripting covering installation, the Python interpreter, variables, strings, data types including lists, tuples, sets, dictionaries, and command-line option parsing."
  zh: "Python脚本概述，涵盖安装流程、Python解释器工具、变量、字符串、列表、元组、集合、字典等数据类型以及命令行选项解析。"
date: 2019-02-17
tags: ["python", "scripting", "basics", "data-types"]
