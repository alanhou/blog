...
<YouTube id="7xTGNNLPyMI" title="Deep Dive into LLMs like ChatGPT - Andrej Karpathy" />

:::en
This post summarizes Andrej Karpathy's video "Deep Dive into LLMs like ChatGPT" (Feb 2025).
...
:::zh
本文总结了 Andrej Karpathy 的视频《深入理解 ChatGPT 等大语言模型》（2025年2月）。
