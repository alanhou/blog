...
seriesOrder: 10
title:
  en: "Chapter 10: Basic Networking - Socket Programming"
  zh: "第10章 网络基础 - Socket编程"
description:
  en: "Learn networking fundamentals with TCP and UDP sockets, and communicate via HTTP and FTP protocols using socket programming in Python."
  zh: "学习网络基础知识，掌握TCP、UDP等socket编程，使用socket通过HTTP和FTP等协议通讯和获取信息。"
date: 2019-02-17
tags: ["python", "networking", "socket", "tcp", "udp"]
