...
seriesOrder: 5
title:
  en: "Chapter 5: Import, Export, and Module Data"
  zh: "第5章 Odoo 12开发之导入、导出以及模块数据"
description:
  en: "Master importing, exporting, and managing module data in Odoo 12 using XML, CSV, and the ORM data loading mechanisms."
  zh: "掌握Odoo 12中使用XML、CSV和ORM数据加载机制进行数据的导入、导出和模块数据管理。"
date: 2019-01-09
tags: ["odoo", "import-export", "module-data", "xml", "csv"]
