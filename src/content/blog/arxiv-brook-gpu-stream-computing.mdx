...
description: "提出 Brook 流式编程模型，将 GPU 抽象为流处理器，为后来的 CUDA 奠定基础"
pubDate: 2004-01-01
duration: 15min
heroImage: '/images/arxiv/brook-gpu.jpg'
category: AI论文
tags: ["GPU Computing", "Stream Processing", "CUDA", "Parallel Computing"]
lang: zh
---
