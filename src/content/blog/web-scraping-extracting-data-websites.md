...
seriesOrder: 16
title:
  en: "Chapter 16: Web Scraping - Extracting Data from Websites"
  zh: "第16章 网络抓取 - 从网站上提取有用的信息"
description:
  en: "Extract data from websites using Python libraries, search for articles and source code through web scraping techniques."
  zh: "使用Python库从网站上提取数据，学习搜索文章和源代码的网络抓取技术。"
date: 2019-02-17
