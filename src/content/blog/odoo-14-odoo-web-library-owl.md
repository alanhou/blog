...
seriesOrder: 16
title:
  en: "Chapter 16: Odoo Web Library (OWL)"
  zh: "第16章 Odoo Web Library (OWL)"
description:
  en: "Learn the OWL framework in Odoo 14 including component lifecycle, state management, and building custom field widgets from scratch."
  zh: "学习Odoo 14中的OWL框架，包括组件生命周期、状态管理以及从零构建自定义字段小部件。"
date: 2021-04-26
tags: ["odoo", "odoo14", "owl", "javascript", "components", "widgets"]
...
在第1和第2步中，我们添加了一个JavaScript文件并将其列举到后台资源中。如果希望学习更多有关静态资源的知识，请参见[第十四章 CMS网站开发](/blog/odoo-14-cms-website-development)中*管理静态资源*一节。
...
OWL是一个单独的库，以外部JavaScript库的形式在Odoo内载入。也可以在其它的项目中使用OWL。有关OWL库请见<https://github.com/odoo/owl>。如果不希望在本机上测试OWL还可以使用在线的playground，在线使用OWL的地址为<https://odoo.github.io/owl/playground>。
