...
seriesOrder: 13
title:
  en: "Chapter 13: Building Graphical User Interfaces"
  zh: "第13章 创建图形化用户界面"
description:
  en: "Create graphical user interfaces in Python using the PyQt module for desktop application development."
  zh: "使用PyQt模块创建Python图形化用户界面。"
date: 2019-02-17
tags: ["python", "gui", "pyqt", "desktop-applications"]
