...
seriesOrder: 10
title:
  en: "Chapter 10: Backend Views - Designing the User Interface"
  zh: "第10章 Odoo 12开发之后台视图 - 设计用户界面"
description:
  en: "Design Odoo 12 backend views including form, tree, search, kanban, calendar, graph, and pivot views."
  zh: "设计Odoo 12后台视图，包括表单、列表、搜索、看板、日历、图表和透视表视图。"
date: 2019-01-17
