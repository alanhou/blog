...
title:
  ...
  zh: "Scaling Laws for Neural Language Models"
description:
  en: "研究语言模型在模型规模、数据规模和计算量方面的损失呈幂律关系，并推导出最优预算分配"
  zh: "研究语言模型在模型规模、数据规模和计算量方面的损失呈幂律关系，并推导出最优预算分配"
date: 2020-01-23
tags: ["arxiv", "scaling-laws", "language-models", "openai", "power-laws"]
image: "/arxiv-visuals/arxiv-scaling-laws-neural-lm.png"
---
...
这篇论文系统研究了语言模型性能与三个关键因素的关系：模型参数量 (N)、数据集大小 (D) 和计算量 (C)。
发现它们之间存在简洁的幂律关系。
