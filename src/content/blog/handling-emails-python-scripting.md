...
seriesOrder: 11
title:
  en: "Chapter 11: Handling Emails with Python Scripting"
  zh: "第11章 使用Python脚本处理邮件"
description:
  en: "Write and send emails programmatically using Python's smtplib module, and learn different protocols for sending emails across servers."
  zh: "使用Python脚本编写和发送邮件，使用smtplib模块在Python程序中发送邮件，学习不同服务器上发送邮件的协议。"
date: 2019-02-17
tags: ["python", "email", "smtplib", "automation"]
