---
series: "odoo12-essentials"
seriesOrder: 9
title:
  en: "Chapter 9: External API - Integrating Third-Party Systems"
  zh: "第9章 Odoo 12开发之外部 API - 集成第三方系统"
description:
  en: "Integrate third-party systems with Odoo 12 using XML-RPC, JSON-RPC, and the OdooRPC library for external API access."
  zh: "使用XML-RPC、JSON-RPC和OdooRPC库集成第三方系统，实现Odoo 12外部API访问。"
date: 2019-01-15
tags: ["odoo", "external-api", "xml-rpc", "json-rpc", "integration"]
