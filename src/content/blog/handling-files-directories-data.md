...
seriesOrder: 5
title:
  en: "Chapter 5: Handling Files, Directories, and Data"
  zh: "第5章 文件、目录和数据处理"
description:
  en: "Handle files and directories with the os module, perform data operations like copy, move, merge, and compare, and work with the tarfile module."
  zh: "使用os模块处理文件和目录，进行数据的复制、剪切、合并和比较操作，以及学习tarfile模块的使用。"
date: 2019-02-17
tags: ["python", "files", "directories", "data-processing"]
