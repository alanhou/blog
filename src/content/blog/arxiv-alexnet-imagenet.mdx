...
description: "在 ImageNet 上使用大规模卷积神经网络，采用 ReLU、Dropout 和数据增强等技术，大幅提升图像分类性能"
pubDate: 2012-12-03
duration: 20min
heroImage: '/images/arxiv/alexnet.jpg'
category: AI论文
tags: ["CNN", "ImageNet", "Deep Learning", "Computer Vision", "ReLU"]
lang: zh
---
