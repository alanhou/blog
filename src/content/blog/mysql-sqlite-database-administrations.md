...
seriesOrder: 18
title:
  en: "Chapter 18: MySQL and SQLite Database Administration"
  zh: "第18章 MySQL和SQLite数据库管理"
description:
  en: "Manage MySQL and SQLite databases with Python, covering database design, plugin frameworks, and producer/consumer code patterns."
  zh: "使用Python管理MySQL和SQLite数据库，学习数据库管理的要求和设计、插件框架修改以及编写producer和consumer代码。"
date: 2019-02-17
tags: ["python", "mysql", "sqlite", "database", "administration"]
