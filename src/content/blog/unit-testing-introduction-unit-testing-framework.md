...
seriesOrder: 3
title:
  en: "Chapter 3: Unit Testing - Introduction to the Unit Testing Framework"
  zh: "第3章 单元测试-单元测试框架的介绍"
description:
  en: "Learn unit testing in Python by creating test cases using the unittest framework for systematic program validation."
  zh: "学习Python中的单元测试，使用unittest框架为测试程序创建单元测试。"
date: 2019-02-17
tags: ["python", "unit-testing", "unittest", "testing"]
