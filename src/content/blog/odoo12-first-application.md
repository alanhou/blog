...
seriesOrder: 3
title:
  en: "Chapter 3: Creating Your First Odoo Application"
  zh: "第3章 Odoo 12 开发之创建第一个 Odoo 应用"
description:
  en: "Create your first Odoo 12 application with models, views, business logic, access security, and website integration."
  zh: "创建第一个Odoo 12应用，包含模型、视图、业务逻辑、权限安全和网站集成。"
date: 2019-01-06
tags: ["odoo", "application", "models", "views", "tutorial"]
