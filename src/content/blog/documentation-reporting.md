...
seriesOrder: 8
title:
  en: "Chapter 8: Documentation and Reporting"
  zh: "第8章 文档和报告"
description:
  en: "Generate documentation and reports with Python scripts, automate information gathering, handle email input/output, and format information."
  zh: "使用Python生成文档和报告信息，自动化信息收集，编写接收邮件的脚本，以及学习信息格式化。"
date: 2019-02-17
tags: ["python", "documentation", "reporting", "automation"]
