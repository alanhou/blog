...
seriesOrder: 7
title:
  en: "Chapter 7: Text Processing and Regular Expressions"
  zh: "第7章 文本处理和正则表达式"
description:
  en: "Master text processing and regular expressions in Python for searching, extracting data, and reading/writing files."
  zh: "掌握Python中的文本处理和正则表达式，进行搜索和提取数据等操作，以及对文件的读取和写入。"
date: 2019-02-17
tags: ["python", "text-processing", "regex", "regular-expressions"]
