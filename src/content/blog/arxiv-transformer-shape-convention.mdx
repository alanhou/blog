...
image: "/arxiv-visuals/arxiv-transformer-shape-convention.png"
---
...
本文重新审视了Transformer语言模型架构中使用的张量形状约定。
标准Transformer在模型宽度、FFN隐藏层大小和注意力头维度之间使用特定的维度比率，
这些比率在很大程度上继承自原始的"Attention Is All You Need"论文，缺乏系统性的论证。
本工作研究替代形状配置是否能产生更好的效率-性能权衡。
...
原始Transformer论文建立了被广泛采用的维度比率：模型维度d_model、FFN隐藏层大小4×d_model、注意力头维度d_model/num_heads。
这些比率在GPT、LLaMA、Qwen和大多数现代架构中被继承，几乎没有被质疑。
