...
image: "/arxiv-visuals/arxiv-rethinking-trust-region-llm-rl.png"
---
...
强化学习（RL）已成为微调大语言模型（LLM）的基石，近端策略优化（PPO）是事实上的标准算法。
尽管PPO被广泛使用，我们认为PPO的核心比率裁剪机制在结构上不适合LLM固有的大词汇表。
