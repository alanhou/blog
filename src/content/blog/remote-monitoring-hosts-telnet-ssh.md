...
seriesOrder: 12
title:
  en: "Chapter 12: Remote Monitoring of Hosts over Telnet and SSH"
  zh: "第12章 使用Telnet和SSH远程监控主机"
description:
  en: "Execute basic server configurations remotely using the Telnet module and SSH protocol for secure host monitoring."
  zh: "通过Telnet模块和SSH协议执行服务器上的基本配置，实现远程监控主机。"
date: 2019-02-17
tags: ["python", "telnet", "ssh", "remote-monitoring"]
