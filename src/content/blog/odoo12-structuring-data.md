...
seriesOrder: 6
title:
  en: "Chapter 6: Models - Structuring the Application Data"
  zh: "第6章 Odoo 12开发之模型 - 结构化应用数据"
description:
  en: "Design Odoo 12 data models with field types, relationships, computed fields, constraints, and the ORM inheritance mechanisms."
  zh: "设计Odoo 12数据模型，包括字段类型、关联关系、计算字段、约束和ORM的继承机制。"
date: 2019-01-11
tags: ["odoo", "models", "orm", "fields", "relationships"]
