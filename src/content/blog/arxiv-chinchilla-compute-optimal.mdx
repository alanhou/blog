...
description: "调研模型规模与训练数据数量的最优比值，提出 Chinchilla 模型，在相同计算预算下通过增加训练数据显著超越更大模型"
pubDate: 2022-03-29
duration: 20min
heroImage: '/images/arxiv/chinchilla.jpg'
category: AI论文
tags: ["Chinchilla", "Scaling Laws", "DeepMind", "Compute Optimal"]
lang: zh
arxiv: "2203.15556"
---
