...
seriesOrder: 9
title:
  en: "Chapter 9: Working with Various File Types"
  zh: "第9章 操作各类文件"
description:
  en: "Process PDF files, Excel spreadsheets, and CSV files in Python - open, edit, and extract information from different file formats."
  zh: "使用Python处理PDF文件、Excel和CSV文件，学习打开、编辑文件并从这些文件中读取信息。"
date: 2019-02-17
tags: ["python", "pdf", "excel", "csv", "file-processing"]
