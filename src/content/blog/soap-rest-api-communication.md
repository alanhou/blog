...
seriesOrder: 15
title:
  en: "Chapter 15: SOAP and REST API Communication"
  zh: "第15章 SOAP和REST API通讯"
description:
  en: "Learn SOAP and REST API fundamentals, their differences, and how to use various libraries for API communication in Python."
  zh: "学习SOAP和REST的基础知识及区别，使用不同的库来调用SOAP API和REST API。"
date: 2019-02-17
tags: ["python", "soap", "rest", "api", "web-services"]
