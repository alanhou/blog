...
闭源模型如OpenAI o1和DeepSeek-R1展示了惊人的多步推理能力,
但开源社区却陷入了"先有鸡还是先有蛋"的困境:
训练推理模型需要高质量推理数据,而生成高质量推理数据又需要强大的推理模型。
...
确保三个特性:遗传多样性(8个科学领域、
1000+个层次化组织的主题)、
详细的生长说明(来自强模型如GPT-4的长篇CoT轨迹)、
质量管控(用多个推理模型交叉验证问题有效性和答案正确性)。
