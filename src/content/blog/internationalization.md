...
seriesOrder: 12
title:
  en: "Chapter 12: Internationalization"
  zh: "第12章 国际化"
description:
  en: "Internationalize Odoo 12 modules with translations, PO files, language installation, and website content localization."
  zh: "使用翻译、PO文件、语言安装和网站内容本地化实现Odoo 12模块的国际化。"
date: 2019-07-14
tags: ["odoo", "i18n", "internationalization", "translations", "localization"]
...
我们需要启用开发者模式。如未启用请参照[第一章 安装Odoo开发环境](/blog/installing-odoo-development-environment)中*激活Odoo开发者工具*一节进行激活。
...
更多详情，请参见[第九章 高级服务端开发技巧](/blog/advanced-server-side-development-techniques)中的*使用变更的上下文调用方法*一节。
...
本节演示如何使用这些工具来帮助插件模块中的翻译。我们要对自定义模块使用它，所以[第四章 创建Odoo插件模块](/blog/creating-odoo-add-on-modules)中创建的my_library是一个不错的对象。但是，请随意替换为你自己手边的其它自定义模块，将本节中的my_library替换为相应模块即可。
...
我们需要启用开发者模式。如未启用请参照[第一章 安装Odoo开发环境](/blog/installing-odoo-development-environment)中*激活Odoo开发者工具*一节进行激活。我们还会需要一个po翻译文件，在本节中我们将进行导入，例如myfile.po文件。
