...
seriesOrder: 4
title:
  en: "Chapter 4: Automating Regular Administrative Activities"
  zh: "第4章 自动化常规运维活动"
description:
  en: "Automate system administration tasks: handle input, passwords, external commands, config files, warnings, CPU limits, web browsers, the os module, and backups."
  zh: "自动化运维管理员的常规运维活动，包括接收输入、处理密码、外部命令执行、读取配置文件、添加警告信息、CPU限制、网页浏览器启动、os模块使用和备份。"
date: 2019-02-17
tags: ["python", "automation", "sysadmin", "os-module"]
