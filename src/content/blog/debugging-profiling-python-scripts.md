...
seriesOrder: 2
title:
  en: "Chapter 2: Debugging and Profiling Python Scripts"
  zh: "第2章 Python脚本调试和性能测试"
description:
  en: "Debug Python programs using debugging tools, handle errors, and learn profiling and timing techniques for performance analysis."
  zh: "使用调试工具对Python程序进行调试，处理错误，深入性能测试和耗时测试的概念。"
date: 2019-02-17
tags: ["python", "debugging", "profiling", "performance"]
