...
seriesOrder: 14
title:
  en: "Chapter 14: Web Server Development"
  zh: "第14章 网页服务端开发"
description:
  en: "Build Odoo 12 web controllers, handle HTTP requests, create REST-like APIs, and manage authentication for web services."
  zh: "构建Odoo 12网页控制器、处理HTTP请求、创建类REST API并管理Web服务的认证。"
date: 2019-07-23
tags: ["odoo", "web-development", "controllers", "http", "api"]
...
我们将在本章中介绍Odoo网页服务端部分的基础知识。本章中所讲解的为基本的部分，有关更高阶的功能，请参见[第十五章 CMS网站开发](/blog/cms-website-development)。
...
我们将使用library.book 模型，可参见[第五章 应用模型](/blog/application-models)，因此如果你还没有按该章进行操作，请获取相关代码以便能按照后面的示例进行操作。
...
> ℹ️手动生成HTML对于演示非常好，但在生产环境的代码中则不应这么做。保持使用模板，如我们在[第十五章 CMS网站开发](/blog/cms-website-development)中的*创建或更改模板 - QWeb*一节中所演示的，并通过调用request.render()返回它们。
>
...
我们将对前一节的代码继续进行扩展，还将依赖[第五章 应用模型](/blog/application-models)中的library.book模型，所以就准备好相关代码来继续下来的学习。
...
- 如果想要学习更多在该路径上的表单提交的话，请参见[第十五章 CMS网站开发](/blog/cms-website-development)中的*从网站用户获取输入*一节。
