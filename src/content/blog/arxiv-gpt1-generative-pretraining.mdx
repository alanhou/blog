...
description: '使用 Transformer 进行无监督语言建模并在多任务上微调，实现通用文本理解'
pubDate: 2018-06-11
heroImage: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800'
heroImageAlt: 'GPT-1 generative pre-training illustration'
tags: ['AI', 'NLP', 'GPT', 'Transformer', 'Pre-training', 'OpenAI']
