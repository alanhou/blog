...
seriesOrder: 7
title:
  en: "Chapter 7: Recordsets - Working with Model Data"
  zh: "第7章 Odoo 12开发之记录集 - 使用模型数据"
description:
  en: "Work with Odoo 12 recordsets: CRUD operations, domain filters, environment management, and data manipulation methods."
  zh: "使用Odoo 12记录集进行CRUD操作、domain过滤、环境管理和数据操作方法。"
date: 2019-01-12
tags: ["odoo", "recordsets", "crud", "domain-filters", "orm"]
