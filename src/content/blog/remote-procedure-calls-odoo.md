...
description:
  en: "Interact with Odoo 12 externally using XML-RPC and JSON-RPC protocols, and build integrations with the OdooRPC library."
  zh: "使用XML-RPC和JSON-RPC协议与Odoo 12进行外部交互，并使用OdooRPC库构建集成。"
date: 2019-07-28
tags: ["odoo", "rpc", "xml-rpc", "json-rpc", "api", "integration"]
