...
image: "/arxiv-visuals/arxiv-native-active-perception-as-reasoning-for.png"
...
3. **Action**: The system executes the query on the raw video/audio, extracts the requested snippet, and updates the memory $M_{t+1}$ with the new information (e.g., a text description of the segment).
...
3. **行动**：系统对原始视频/音频执行查询，提取请求的片段，并用新信息（如该片段的文字描述）更新记忆 $M_{t+1}$。
